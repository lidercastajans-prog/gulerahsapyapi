...
export const categories: ModelCategory[] = [
  {
    ...
    models: [
      ...
      },
      {
        ...
        levels: "Tek kat",
        deliveryTime: "6-8 hafta",
        highlight: "Geniş yaşam alanı",
        description: "Modern tasarımlı, geniş pencereli ve ferah yaşam alanına sahip ideal tiny house modeli.",
        longDescription: [
          "Finike 35, doğal ahşap dokusunu modern mimari ile buluşturur. Büyük pencereleri ile gün ışığından maksimum faydalanır.",
          "Tam donanımlı mutfak ve banyosu ile 4 kişiye kadar konaklama imkanı sunar."
        ],
        features: ["Geniş ön cam cephe", "Tam donanımlı L mutfak", "Akıllı ev altyapısı", "Yüksek yalıtım", "Ahşap lambri iç kaplama"],
        includes: ["Çelik şasi", "Elektrik ve su tesisatı", "Mutfak dolapları", "Banyo vitrifiye", "Dış cephe koruma"],
        options: ["Solar panel", "Teras eklentisi", "Klima", "Şömine"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        highlight: "Asma katlı loft tasarım",
        description: "Yüksek tavanı ve asma katı ile daha fazla kişiye rahat konaklama imkanı sunan loft tiny house.",
        longDescription: [
          "Kaş 40, loft tasarımıyla dar alanda ferah bir yaşam sunar. Asma katı sayesinde yatak odası tamamen izole edilmiştir.",
          "Büyük aileler veya kalabalık arkadaş grupları için mükemmel bir alternatiftir."
        ],
        features: ["Yüksek tavan (3.8m)", "Asma kat yatak odası", "Kompakt tasarım", "Çift cidarlı izolasyon", "Özel tasarım merdiven"],
        includes: ["Çelik şasi", "Standart tesisatlar", "Banyo ve mutfak", "Ahşap merdiven", "İç dış kaplama"],
        options: ["Güneş enerjisi", "Yerden ısıtma", "Outdoor duş"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        bath: "1 banyo",
        capacity: "4-6 kişi",
        levels: "Tek kat + geniş veranda",
        deliveryTime: "7-9 hafta",
        highlight: "Ekstra geniş veranda",
        description: "Dış mekan yaşamını sevenler için özel tasarlanmış, geniş verandasıyla dikkat çeken model.",
        longDescription: [
          "Kumluca 45, yaşam alanını dışarıya taşıyan devasa verandası ile öne çıkar. Yaz aylarında hayatınızın çoğu bu verandada geçecek.",
          "Geniş iç hacmi ile uzun süreli konaklamalara uygundur."
        ],
        features: ["15m² Ahşap veranda", "Açık plan mutfak", "Geniş banyo", "Doğal havalandırma", "Özel gölgelik"],
        includes: ["Beton temel veya şasi", "Veranda döşemesi", "Tesisatlar", "Banyo donanımları", "Emprenye kaplama"],
        options: ["Pergola sistemi", "Açık hava mutfağı", "Kış bahçesi camlama"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        highlight: "Geniş loft alan",
        description: "Maksimum hacim arayanlar için tasarlanmış, devasa pencereleri olan premium tiny house.",
        longDescription: [
          "Demre 50, tiny house konseptinin sınırlarını zorlayan genişlikte bir modeldir. Loft katında iki ayrı uyku alanı bulunur.",
          "Tam zamanlı yaşam için ihtiyaç duyulabilecek tüm depolama alanlarına sahiptir."
        ],
        features: ["İki ayrı loft yatak", "Geniş depolama alanları", "Panoramik camlar", "Premium yalıtım", "Akıllı ev sistemi"],
        includes: ["Ağır çelik şasi", "Tüm tesisatlar", "Premium mutfak", "Lüks banyo", "Dış cephe ahşap"],
        options: ["Off-grid paket", "Şömine", "Otomatik panjurlar", "Yerden ısıtma"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        levels: "Çift katlı",
        deliveryTime: "8-10 hafta",
        highlight: "Çift banyolu ebeveyn tasarımı",
        description: "Misafir ağırlamayı sevenler için, ebeveyn banyolu lüks tiny house modeli.",
        longDescription: [
          "Kalkan 55, bir tiny house'tan çok daha fazlasını sunar. İçerisinde iki ayrı banyo barındıran ender modellerdendir.",
          "Lüks tatil köyleri ve özel araziler için ideal bir tasarımdır."
        ],
        features: ["Ebeveyn banyosu", "Çift katlı tasarım", "Geniş mutfak adası", "Ses yalıtımı", "Gizli aydınlatmalar"],
        includes: ["Temel veya şasi", "İki banyo donanımı", "Mutfak adası", "Tesisatlar", "İç dış son kat kaplamalar"],
        options: ["Tam akıllı ev", "Veranda", "Güneş enerjisi", "Klima sistemi"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        highlight: "Geniş ailelere özel",
        description: "Geniş aileler için tasarlanmış, 3 yatak odasına sahip tek katlı dev tiny house.",
        longDescription: [
          "Patara 60, üç yatak odası ile en kalabalık aileleri bile rahatça misafir edebilir. Uzun yapısı sayesinde alan kaybı yaşatmaz.",
          "Özellikle yazlık kullanım için mükemmel bir alternatiftir."
        ],
        features: ["3 Yatak odası", "Uzun koridor planı", "Geniş veranda çıkışı", "Yüksek dayanıklılık", "Ekolojik malzemeler"],
        includes: ["Çelik şasi", "Tüm bölme duvarlar", "Mutfak ve banyo", "Tesisatlar", "Ahşap cephe"],
        options: ["İkinci banyo", "Büyük veranda", "Yerden ısıtma", "Ada mutfak"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      },
      {
        ...
        levels: "Çift kat",
        deliveryTime: "10-12 hafta",
        highlight: "Maksimum konfor ve hacim",
        description: "Tiny house sınırlarının ulaştığı en büyük ölçülerde, tam zamanlı lüks yaşam alanı.",
        longDescription: [
          "Kekova 65, taşınabilir ev konseptinin zirvesidir. Hem iki katlı yapısı hem de çift banyosu ile tam donanımlı bir evden farksızdır.",
          "Dört mevsim, yıllar boyu ailenizle yaşayabileceğiniz dayanıklı ve konforlu bir yapıdır."
        ],
        features: ["İki katlı lüks plan", "Çift banyo", "Devasa yaşam alanı", "Premium yalıtım paketi", "Lüks mutfak"],
        includes: ["Ağır hizmet şasisi", "Tüm iç/dış kaplamalar", "İki banyo tam takım", "Lüks ankastre mutfak", "Akıllı altyapı"],
        options: ["Off-grid güneş paketi", "Şömine", "Kış bahçesi", "Akıllı ev otomasyonu"],
        image: `${wp}/dummy.jpg`,
        gallery: [],
      }
    ],
